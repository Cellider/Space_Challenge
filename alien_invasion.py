...
class AlienInvasion:
	...
	def __init__(self):
		...
		# fullscreen if you want to, just delete the self.screen 
	...
	def _update_aliens(self):
		"""Moves the fleet of aliens to the right and then to left"""
	...
	def _check_aliens_bottom(self):
		...
		for alien in self.aliens.sprites():
			if alien.rect.bottom >= screen_rect.bottom:
				# Treat this the same way if the ship got hit
				self._ship_hit()
				break
